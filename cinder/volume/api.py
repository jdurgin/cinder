...
class API(base.Base):
    ...
    def _create(self, context, size, name, description, snapshot=None,
    ...
    def create(self, context, size, name, description, snapshot=None,
        ...
        volume = self._create(context, size, name, description, snapshot,
    ...
    def create_volume_from_image(self, context, size, name, description,
                                 image_id, volume_type=None, metadata=None,
        ...
        volume = self._create(context, size, name, description, None,
                              volume_type, metadata, availability_zone)

        rpc.cast(context,
                 FLAGS.scheduler_topic,
                 {"method": "create_volume_from_image",
                  "args": {"topic": FLAGS.volume_topic,
                           "volume_id": volume['id'],
                           "image_id": image_id}})
        return volume
