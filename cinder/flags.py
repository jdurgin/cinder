...
global_opts = [
    ...
    cfg.BoolOpt('glance_service_catalog',
                default=False,
                help='obtain Glance API configs from service catalog'),
    cfg.StrOpt('glance_service_type',
                default='image',
                help='Service catalog server type used for Glance.'),
    cfg.StrOpt('glance_endpoint_region',
                default=None,
                help='Service catalog region name for Glance.'),
    cfg.StrOpt('glance_endpoint_type',
                default='publicURL',
                help='Service catalog endpoint type for Glance.'),
